    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChandaNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    MuqamId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DilaId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmissionWindowId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SubmitterChandaNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChandaNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    WasiyatNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    NextOfKinPhoneNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
